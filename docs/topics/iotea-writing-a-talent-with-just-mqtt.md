...
- Your MQTT Client should be connected the the broker instance, the platform is connected to
  - Subscribe to the following topics:<br>
    _remote/_ is optional, since it's only needed when you are running on a broker, where the platform is not connected to<br>
    ...
    - `$share/<talentId>/(remote/)talent/<talentId>/events` (_Topic B_)
    - `(remote/)talent/<talentId>/events/<callChannelId>/+` (_Topic C_)
...
- `$share/<talentId>/configManager/talents/discover` (_Topic A_)
...

  {
    "msgType": 2,
    "version": "1.0.0",
    "returnTopic": "123456/configManager/talent/discover"
  }
  ```

  ```json
  // You answer to message.returnTopic (here: 123456/configManager/talent/discover)
...
- `(remote/)talent/<talentId>/events/<callChannelId>/<deferredCallId>` (_Topic C_)<br>
  ...
  You would subscribe to `(remote/)talent/<talentId>/events/<callChannelId>/+`
...

  {
      ...
      "instance": "default",
      "value": {
          "$tsuffix": "<callChannelId>/<deferredCallId>",                             // Routing metadata
          ...
          "<talentId>.fibonacci-out": {
            "default": {
              "$feature": {
                "enc": null,
                "raw": {
                    "$tsuffix": "<callChannelId>/<deferredCallId>",
                    "$vpath": "value",
                    "value": "42"
                },
                "whenMs": 1605026236000,
